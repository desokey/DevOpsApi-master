...
function Get-TeamsAndPermsions()
{
    ...
    # $projectUri = "https://dev.azure.com/" + $userParams.VSTSMasterAcct + "/cont-surround" +  "/_apis/wit/recyclebin?api-version=5.0"
...
function Get-GroupList() 
{
    ...
    #Write-Output "" | Out-File -FilePath $outFile -Append
    Write-Output 'Group Name,UserName,type,origin, ID,Email Address' $item.displayName | Out-File -FilePath $outFile -Append -NoNewline
    Write-Output "" | Out-File -FilePath $outFile -Append
