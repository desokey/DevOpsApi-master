    ...
    foreach ($Env in $envMain)
    {
        ...
        foreach ($Deploy in $EnvDeps.value) 
        {
            ...
            foreach ($stg in $tmStages) 
            {
                ...
                # https://dev.azure.com/cont-strat-pgm/_apis/Contribution/HierarchyQuery/project/633b0ef1-c219-4017-beb0-8eb49ff55c35?api-version=5.0-preview.1
...
function Get-AllUSerMembership(){
    ...
    Write-Output 'Project|Group Name|Type|Relationship|User Name|Email Address|ID' | Out-File -FilePath $outFile
